...
public class GameConfig {
	...
	public static final int BOMBER_SPAWN_RATE_INV = 200;
	...
	public static final int METEOR_REMOVED_SCORE = 7;
	public static final int CITY_SURVIVE_SCORE = 300;
	public static final int MISSILE_LEFT_SCORE = 25;

	public static final int END_GAME_COST = 10000;
	
	public static final int BLACK_HOLE_COST = 800;
	public static final int FORCEFIELD_COST = 1200;
	public static final int MISSILE_COST = MISSILE_LEFT_SCORE * 2;
	public static final int CITY_COST = 1500;
	public static final int FRIENDLY_EXPLOSIONS_COST = 3000;
